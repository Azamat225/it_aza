...
urlpatterns = [
    ...
    path('create_task_template/', views.create_task_template, name='create_task_template'),
    path('get_template_data/<int:template_id>/', views.get_template_data, name='get_template_data'),
    path('templates/', views.task_templates_list, name='task_templates_list'),
    ...
    path('templates/<int:template_id>/delete/', views.delete_task_template, name='delete_task_template'),
]
