...
class TaskTemplate(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        related_name='director_templates',
...
class ManagerTaskTemplate(models.Model):
    title = models.CharField(max_length=200, verbose_name='Название')
    description = models.TextField(verbose_name='Описание')
    max_assigned_users = models.PositiveIntegerField(verbose_name='Максимальное количество исполнителей')
    created_by = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='manager_templates', verbose_name='Создано пользователем')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')
    is_public = models.BooleanField(default=True, verbose_name='Доступно всем')

    class Meta:
        verbose_name = 'Шаблон задачи менеджера'
        verbose_name_plural = 'Шаблоны задач менеджеров'
        ordering = ['-created_at']
